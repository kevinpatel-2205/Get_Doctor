...
<body>
    ...
    $usergender=$doctortb['DGENDER'];
    $usernumber=$doctortb['DNUMBER'];
    $useraddress=$doctortb['DADDRESS'];
    $userdob=$doctortb['DDATE_OF_BIRTH'];
    $usersid=$doctortb['SID'];
    $qu=$db->query("SELECT * FROM specialization WHERE SID='$usersid'");
    $specialization=$qu->fetch_assoc();
    $userspecialization=$specialization['SPECIALIZATION'];
    $userexpyears=$doctortb['DEXPERIENCE_YEARS'];
    $userqualification=$doctortb['DQUALIFICATION'];
                ...
                <tr>           
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;"><u>View Details.</u></p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label"><b>Number: </b></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php echo $usernumber; ?><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label"><b>Gender: </b></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php echo $usergender; ?><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                            <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $useraddress; ?><br><br>
                            </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Date of Birth: </b></label>
                                    
                                </td>
                            </tr>
                            <tr>
                            <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $userdob; ?><br><br>
                            </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spe" class="form-label"><b>Specialization: </b></label>
                                    
                                </td>
                            </tr>
                            <tr>
                            <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $userspecialization; ?><br><br>
                            </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="sp" class="form-label"><b>Experience Years: </b></label>
                                    
                                </td>
                            </tr>
                            <tr>
                            <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $userexpyears; ?><br><br>
                            </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spe" class="form-label"><b>Qualification: </b></label>
                                    
                                </td>
                            </tr>
                            <tr>
                            <td class="label-td" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $userqualification; ?><br><br>
                            </td>
                            </tr>
                            <tr>
                                <td colspan="2">

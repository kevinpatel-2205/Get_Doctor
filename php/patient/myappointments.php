...
<body>
    ...
    $q = "SELECT * FROM appointment WHERE PID='$userid'";
    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-appoinment  menu-active menu-icon-appoinment-active">
            <a href="myappointments.php" class="non-style-link-menu non-style-link-menu-active">
                <div>
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0" style="margin-top: 25px;">
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="myappointments.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Appointments &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                        ...
                                        for ($x = 0; $x < $result->num_rows; $x++) {
                                            ...
                                            $doctordata=$db->query("select * from doctor Where DID='$did'");
                                            $doctortb=$doctordata->fetch_assoc();
                                            $doctorname=$doctortb['DNAME'];
                                            // $fees=$doctortb['FEES'];
                                            $fees=$row['FEES'];
                                            $spe=$row['SID'];
                                            $spcil_res = $db->query("select * from specialization where SID='$spe'");
                                            $spcil_array = $spcil_res->fetch_assoc();
                                            $spcil_name = $spcil_array["SPECIALIZATION"];
                                            echo '<tr>
                                        <td> &nbsp;' .
                                                $no
                                                . '</td>

                    ...
                    <center>
                        <table class="filter-container doctor-header patient-header" style="border: none;width:95%" border="0">
                            <tr>
                                <td>
                                    <h3>Welcome!</h3>
                                    <h1><?php echo $patienttb['PNAME']; ?></h1>
                                    <p>Haven't any idea about doctors ? no problem let's jumping to
                                        ...
                                        <a href="myappointments.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                    ...
                                    <td style="width: 25%;">
                                        <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                            <div>
                                                <div class="h1-dashboard">
                                                    <?php
                                                    $query = "SELECT * FROM appointment WHERE PID='$userid' and APPOINTMENT_DATE='$today'";
                                                    $patient = $db->query($query);
                                                    echo $patient->num_rows;
                                                    ?>
                                                </div><br>
                        ...
                        <div class="abc scroll" style="height: 250px;padding: 0;margin: 0;">
                            <table width="85%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sqlmain = "SELECT * FROM appointment WHERE PID=$userid and APPOINTMENT_DATE>=$today";
                                    //echo $sqlmain;

...
<body>
    ...
    <div class="dash-body" style="margin-top: 15px">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
            ...
            <?php
            $patientquery = "SELECT * FROM patient order by PID";
            $patienttb = $db->query($patientquery);
            $patientno = $patienttb->num_rows;
            ?>
            <tr>
                <td colspan="4" style="padding-top:10px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"> All Patients (<?php echo $patientno; ?>)</p>
                </td>
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0" style="margin-top: 25px;">
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        while ($patientttb = $patienttb->fetch_assoc()) {
                                            $id = $patientttb["PID"];
                                            $name = $patientttb["PNAME"];
                                            $email = $patientttb["PEMAIL"];
                                            $address = $patientttb["PADDRESS"];
                                            $number = $patientttb['PNUMBER'];
            ...
            <tr>
                <form method="POST" action="generate_patient_pdf.php">
